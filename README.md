...
1. **Loan Approval Prediction using Machine Learning**
...
2. **Breast Cancer Classification using Machine Learning**
...
3. **Decision Tree Classifier on Iris Dataset**
...
4. **Decision Tree Classifier on Car Evaluation**
...
5. **Random Forest Classifier on the Palmer Penguins Dataset**
...
5. **Concrete Compressive Strength Prediction (Random Forest Regression)**
...
7. **Telco Customer Churn Prediction (Random Forest Classification)**
...
8. **Linear Regression on Advertising Dataset**
...
9. **Mall Customers Segmentation using K-Means Clustering**
